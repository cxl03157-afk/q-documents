...
# terraform.tfvars を開いて budget_notification_email を記入する
```
...
| S3 のバケットポリシー | OAC からの読み取り許可には CloudFront ディストリビューションの ARN が要る。8/7 の公開層で追加する |
| S3 の CORS 設定 | 署名付きURLでブラウザから直接 PUT するために要るが、許可する Origin は CloudFront のドメイン。8/7 に追加する |
